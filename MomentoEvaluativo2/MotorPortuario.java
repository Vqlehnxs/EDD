public class MotorPortuario {
    public static void main(String[] args) {
        ...
        manifiesto.registrar(new Contenedor("C002", 850.5, 3));
        manifiesto.registrar(new Contenedor("C003", 2300.0, 2));
        manifiesto.registrar(new Contenedor("C004", 500.0, 4));
        manifiesto.registrar(new Contenedor("C005", 1800.0, 1));
        manifiesto.registrar(new Contenedor("C006", 750.0, 3));
        manifiesto.resumen();

        System.out.println("Patio de Almacenamiento (3x3)");
        ...
        System.out.println("Bahia de Inspeccion");
        ...
        System.out.println("Ubicacion en el Buque");
        Buque buque = new Buque(true);

        Contenedor[] carga = {
            new Contenedor("C003", 2300.0, 2),
            new Contenedor("C001", 1200.0, 1),
            new Contenedor("C005", 1800.0, 1),
            new Contenedor("C006", 750.0, 3),
            new Contenedor("C002", 850.0, 3),
